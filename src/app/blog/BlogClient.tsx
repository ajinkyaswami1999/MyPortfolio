...
import { Search, Calendar, Clock, Filter, ArrowRight } from "lucide-react";
              ...
              {filteredPosts.map((post) => (
                ...
                >
                  <Link href={`/blog/${post.id}`} className="flex flex-col justify-between h-full w-full">
                    ...
                    {/* Read Link */}
                    <div className="flex items-center space-x-2 text-xs font-bold text-slate-400 group-hover:text-brand-cyan transition-colors mt-4 text-left">
