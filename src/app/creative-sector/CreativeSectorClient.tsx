                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-7 space-y-6">
                      <div className="glass-panel p-6 md:p-8 rounded-3xl border border-white/5 bg-[#111111]/75">
                        ...
                        <div className="space-y-4 text-slate-400 text-xs md:text-sm leading-relaxed text-left">
                          <p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {businessSkills.map((skill) => (
                            ...
                            >
                              ...
                              <p className="text-slate-500 text-[10.5px] leading-relaxed font-sans text-left">{skill.desc}</p>
                            </div>
                          ))}
                        </div>
                      </div>
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-5 space-y-6">
                        ...
                        <div className="space-y-3.5">
                          {qualitySteps.map((step) => (
                            ...
                            >
                              ...
                              <div>
                                <h3 className="text-xs font-bold text-white mb-0.5 text-left">{step.title}</h3>
                                <p className="text-[10px] text-slate-500 leading-normal text-left">{step.desc}</p>
                              </div>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="glass-panel p-6 border border-brand-purple/20 bg-slate-950/40 rounded-3xl">
                        <h2 className="text-xs font-mono uppercase tracking-widest text-slate-500 mb-4 text-left">
                  ...
                  {toolCategories.map((cat) => (
                    ...
                    >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="mt-6 w-full flex items-center justify-center space-x-1.5 py-2.5 bg-slate-950 hover:bg-slate-900 border border-white/5 hover:border-brand-amber/40 text-[10px] font-mono uppercase tracking-wider font-bold text-slate-200 hover:text-white rounded-xl transition-all cursor-pointer"
                      >
                ...
                >
                  ...
                  >
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <h3 className="text-xs font-bold font-display text-slate-200 font-sans text-left">WORKSHOP EXIF / CAMERA SPEC SHEET</h3>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 font-mono text-xs text-slate-400 text-left">
                    ...
                    {mockPhotos.map((photo) => (
                      ...
                      >
                        ...
                        <div className="p-6 text-left flex-1 flex flex-col justify-between">
                          ...
                          <div className="flex items-center space-x-2 pt-4 border-t border-white/5 font-mono text-[9px] text-brand-cyan text-left">
                            <Aperture size={10} />
