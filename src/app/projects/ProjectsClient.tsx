            ...
            >
              {filteredProjects.map((project, index) => (
                ...
                >
                  ...
                  <div className="absolute top-3 right-6 font-mono text-[7px] text-slate-650 uppercase tracking-widest pointer-events-none select-none">
                  ...
                  <div>
                    ...
                    <div className="border-t border-white/5 pt-5 mt-4 text-left">
